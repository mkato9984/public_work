document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupDeleteButtons() {
        ...
        console.log(`削除ボタンを設定中: ${deleteButtons.length} 個のボタンが見つかりました`);
        
        deleteButtons.forEach((button, index) => {
            console.log(`削除ボタン ${index + 1}: data-id = ${button.getAttribute('data-id')}`);
            ...
            button.addEventListener('click', (event) => {
                ...
                console.log(`削除ボタンがクリックされました: 文書ID = ${documentId}`);
